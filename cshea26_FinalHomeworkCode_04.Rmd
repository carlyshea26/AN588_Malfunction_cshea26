...
a <- ggplot(datas, aes(x = Brain_Size_Species_Mean, y = MaxLongevity_m)) +
  ...
  labs(x = "Brain Size", y = "Max Longevity", 
       title = "Regression of Brain Size vs. Longevity", color = "Legend") +
  theme_minimal()
...
3. I provided two different ways of making CIs for model 2 and would appreciate any feedback any peer comment-er has regarding them. 
