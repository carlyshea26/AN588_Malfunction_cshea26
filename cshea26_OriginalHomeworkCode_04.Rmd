...
y <- brain - mean(brain)
x <- longevity - mean(longevity) # find the mean of each variable

z <- data.frame(x = x, y = y) # create a dataframe to display longevity and brain size means

g <- ggplot(data = z, aes(x = x, y = y)) + 
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x) +
  stat_regline_equation(aes(label = ..eq.label..)) # create a graph to display
